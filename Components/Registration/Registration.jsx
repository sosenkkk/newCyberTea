      ...
      <div className="max-w-md mx-auto p-6 bg-white border border-gray-300 rounded shadow">
        ...
        <div>
          ...
          <ul className="text-base lg:text-lg mt-2 list-decimal list-inside">
            <li className="mb-2">
              Pay the registration fee using the below payment methods and
              amount according to your category.
            </li>
            <li className="mb-2">
              After payment, fill out the{" "}
              <a
                href="/register"
                target="_blank"
                rel="noreferrer"
            ...
            <table className="w-full table-auto">
              <thead>
                <tr className="bg-gray-200">
                  <th className="py-2 px-4 tableCellStyle">Participant Type</th>
        ...
        <div className="lg:flex justify-between mt-4">
          <div className="w-full lg:w-1-2">
            ...
            <a href="" target="_blank" rel="noreferrer" className="qr_scanner">
          ...
          <div className="w-full lg:w-1-2 mt-4 lg:mt-0">
            ...
            <p className="mt-2 text-sm lg:text-base">
              ...
              <br />
              BANK ACCOUNT NUMBER: 38329375681
              <br />
              IFSC CODE: SBIN0016527
              <br />
              MICR CODE: 517002825
              <br />
        ...
        <p className="text-center text-lg lg:text-2xl font-bold text-yellow-400 mt-4">
          After the payment, fill out the form to confirm your registration{" "}
          <a
            href="https://forms.gle/To8gFQaw9cRxEi6z7"
            target="_blank"
            rel="noreferrer"
            className="linkStyle"
          >
